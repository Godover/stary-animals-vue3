  ...
  <div>
    ...
    >
      ...
      <div class="ivu-fr" style="display: flex">
        <Button type="primary" @click="push('/seek_publish/0')"
          >发布寻宠</Button
        >
      </div>
    </div>
    ...
    <Row>
      ...
      <Col span="23">
        <TagSelect v-model="chooseCity">
          <TagSelectOption v-for="item in cityArray" :name="item">{{
            item
          }}</TagSelectOption>
        </TagSelect>
      </Col>
    ...
    <Row class-name="ivu-mt-8">
      ...
      <Col span="23">
        ...
        <TagSelect v-model="chooseCategory">
          <TagSelectOption v-for="item in categoryArray" :name="item">{{
            item
          }}</TagSelectOption>
        </TagSelect>
      </Col>
    ...
    <Row class-name="ivu-mt-8">
      ...
      <Col span="23">
        ...
        <TagSelect v-model="chooseType">
          <TagSelectOption v-for="item in typeArray" :name="item">{{
            item
          }}</TagSelectOption>
        </TagSelect>
      </Col>
    ...
    <Row class-name="ivu-mt-8">
      ...
      <Col span="23">
        ...
        <TagSelect v-model="chooseMoney">
          <TagSelectOption v-for="item in moneyArray" :name="item">{{
            item
          }}</TagSelectOption>
        </TagSelect>
      </Col>
    ...
    <div style="display: flex">
      <div class="cardContainer">
        <div
          style="background: #f8f8f8; padding: 4px; width: 900px"
      ...
      <div style="width: 500px; background: #fafafa; border-radius: 5px">
        <Title
          :level="4"
          style="color: #ed4014; margin-top: 10px; margin-left: 20px"
          >热门信息</Title
        >
        <div
          v-for="(item, index) in hotList"
          :key="index"
          style="width: 200px; margin: 15px 20px"
        >
