...
<script>
import {adoptChangeStatus, adoptListByUserId} from "@/http/api/adoptApi";
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {"title": "供求", "width": 70, "align": "center", "slot": "supply"},
  ...
  methods: {
    ...
    changeStatus(bizId, status) {
      ...
      adoptChangeStatus(bizId, status)
          .then(() => {
            setTimeout(loadingVerify, 0);
